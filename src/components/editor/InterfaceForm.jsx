          ...
          <div className='rmodal-body'>
            <div className='form-group row'>
              ...
              <div className='col-sm-10'>
                <input name='name' tabIndex={1} value={this.state.name}
                       onChange={e => this.setState({name: e.target.value})} className='form-control' placeholder='Name'
                       spellCheck='false' autoFocus='true' required/>
              </div>
            </div>
            <div className='form-group row'>
              <label className='col-sm-2 control-label'>地址：</label>
              <div className='col-sm-10'>
                <input name='name' tabIndex={2} value={this.state.url}
                       onChange={e => this.setState({url: e.target.value})} className='form-control' placeholder='URI'
            ...
            <div className='form-group row'>
              ...
              <div className='col-sm-10'>
                <select name='method' tabIndex={3} value={this.state.method}
                        onChange={e => this.setState({method: e.target.value})} className='form-control'>
                  {METHODS.map(method =>
            ...
            <div className='form-group row'>
              ...
              <div className='col-sm-10'>
                <select name='status' tabIndex={4} value={this.state.status}
                        onChange={e => this.setState({status: e.target.value})} className='form-control'>
            ...
            <div className='form-group row'>
              ...
              <div className='col-sm-10'>
                <SmartTextarea name='description' tabIndex={5} value={this.state.description}
                               onChange={e => this.setState({description: e.target.value})} className='form-control'
                               placeholder='Description' spellCheck='false' rows='5'/>
              </div>
            </div>
          </div>
